...
public class TestFibonacciProgression {
	...
	private static void test_printProgressionWithDefaultConstructor() {
		...
		System.out
				.println("end: test_printProgressionWithDefaultConstructor()\n===\n");
	}
	...
	private static void test_printProgressionWithArgumentsConstructor() {
		FibonacciProgression fibonacciProgression = new FibonacciProgression(4,
				6);
		fibonacciProgression.printProgression(10);
		System.out
				.println("end: test_printProgressionWithArgumentsConstructor()\n===\n");
	}
